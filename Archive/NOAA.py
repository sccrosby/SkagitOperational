...
def getTides(mllw2NAVD88, timeDifference):
    ...
    for dayDiff in range(2):
        ...
        NOAA = ('https://tidesandcurrents.noaa.gov/noaatidepredictions.html?id=9448576&units=standard&'+
            'bdate={0:04d}{1:02d}{2:02d}&edate=20170503&timezone=GMT&clock=12hour&datum=MLLW&interval=h&'+
            'action=data'.format(date.year, date.month, date.day))
        print NOAA
